    ...
    <article class="article">
        ...
        <ul class="social-share">
            <li class="social-share__item social-share__item--facebook">
                <a class="social-share__link social-share__link--facebook social-share__link--facebook-bottom" data-event="facebook-bottom" href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<? print(urlencode($current_url));?>', 'facebook_share_dialog', 'width=626,height=436');return false;">
            ...
            <li class="social-share__item social-share__item--twitter">
                <a class="social-share__link social-share__link--twitter social-share__link--twitter-bottom" data-event="twitter-bottom" href="#" onclick="window.open('http://twitter.com/intent/tweet?status=<?print(urlencode($title));?> <? print(urlencode($current_url));?>', 'twitter-share-dialog', 'width=626,height=436');return false;">
