    ...
    <article class="article">
        ...
        <ul class="social-share social-share--top">
            <li class="social-share__item social-share__item--facebook">
                <a class="social-share__link social-share__link--facebook social-share__link--facebook-top" data-action="Facebook Share - Top" data-label="<? echo $user_ip;?>" href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<? print(urlencode($current_url));?>', 'facebook_share_dialog', 'width=626,height=436');return false;">
        ...
        <ul class="social-share social-share--bottom">
            <li class="social-share__item social-share__item--facebook">
                <a class="social-share__link social-share__link--facebook social-share__link--facebook-bottom" data-action="Facebook Share - Bottom" data-label="<? echo $user_ip;?>" href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<? print(urlencode($current_url));?>', 'facebook_share_dialog', 'width=626,height=436');return false;">
                    <span class="icon-social icon-social--facebook" role="presentation" aria-hidden="true">
                        <svg viewBox="0 0 33 33" width="25" height="25" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M 17.996,32L 12,32 L 12,16 l-4,0 l0-5.514 l 4-0.002l-0.006-3.248C 11.993,2.737, 13.213,0, 18.512,0l 4.412,0 l0,5.515 l-2.757,0 c-2.063,0-2.163,0.77-2.163,2.209l-0.008,2.76l 4.959,0 l-0.585,5.514L 18,16L 17.996,32z"></path></g></svg>
                    </span>
                     Share on Facebook
