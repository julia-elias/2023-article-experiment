...
$(document).ready(function () {
  ...
  function receiveMessage(event) {
    var whitelist = ['https://localhost:3000', 'https://demonstrating-balance.test', 'https://thenewsbeat.org', 'https://stroudresearch.net', 'https://mediaengagement.org', 'https://utexas.ca1.qualtrics.com'];
